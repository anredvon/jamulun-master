(() => {
  ...
  const el = {
    ...
    reportImage: document.getElementById('tarot-report-image'),
  ...
  function openModal(card) {
    ...
    if (el.image) {
      el.image.src = cardImageUrl(card);
  ...
  function renderReport() {
    ...
    if (el.reportImage) {
      el.reportImage.src = cardImageUrl(selectedCard);
      el.reportImage.alt = `${selectedCard.title} 카드 미리보기`;
    }
